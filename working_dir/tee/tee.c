...
static void w2c_tee_0x5Fstart_0(w2c_tee*);

FUNC_TYPE_T(w2c_tee_t0) = "\xf6\x98\x1b\xc6\x10\xda\xb7\xb2\x63\x37\xcd\xdc\x72\xca\xe9\x50\x00\x13\xba\x10\x6c\xde\x87\x27\x10\xf8\x86\x2f\xe3\xdb\x94\xe4";
FUNC_TYPE_T(w2c_tee_t1) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_tee_t2) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static void init_globals(w2c_tee* instance) {
  instance->w2c_g0 = 0u;
  instance->w2c_g1 = 8u;
  instance->w2c_g2 = 1024u;
}

static void init_memories(w2c_tee* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 1, 65536, 0);
}

/* export: 'memory' */
wasm_rt_memory_t* w2c_tee_memory(w2c_tee* instance) {
  return &instance->w2c_memory;
}

/* export: '_start' */
void w2c_tee_0x5Fstart(w2c_tee* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  w2c_tee_0x5Fstart_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_tee* instance, struct w2c_wasi__unstable* w2c_wasi__unstable_instance) {
  instance->w2c_wasi__unstable_instance = w2c_wasi__unstable_instance;
}

void wasm2c_tee_instantiate(w2c_tee* instance, struct w2c_wasi__unstable* w2c_wasi__unstable_instance) {
...
void wasm2c_tee_free(w2c_tee* instance) {
  wasm_rt_free_memory(&instance->w2c_memory);
}

wasm_rt_func_type_t wasm2c_tee_get_func_type(uint32_t param_count, uint32_t result_count, ...) {
  va_list args;
...
void w2c_tee_0x5Fstart_0(w2c_tee* instance) {
  u32 var_l0 = 0;
  FUNC_PROLOGUE;
  ...
  var_L0: 
    ...
    var_i4 = 4u;
    var_i3 += var_i4;
    var_i0 = w2c_wasi__unstable_fd_read(instance->w2c_wasi__unstable_instance, var_i0, var_i1, var_i2, var_i3);
    var_l0 = var_i0;
    var_i0 = 0u;
    var_i1 = var_l0;
