...
static void w2c_matrix_performance_test_0(w2c_matrix*);

FUNC_TYPE_T(w2c_matrix_t0) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";
FUNC_TYPE_T(w2c_matrix_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static void init_globals(w2c_matrix* instance) {
  instance->w2c_g0 = 32u;
  instance->w2c_g1 = 1024u;
  instance->w2c_g2 = 0u;
  instance->w2c_g3 = 4096u;
  instance->w2c_g4 = 8192u;
}

static void init_memories(w2c_matrix* instance) {
}

/* export: 'performance_test' */
void w2c_matrix_performance_test(w2c_matrix* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base((*instance->w2c_env_memory).data);
#endif
  w2c_matrix_performance_test_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_matrix* instance, struct w2c_env* w2c_env_instance) {
  instance->w2c_env_instance = w2c_env_instance;
  instance->w2c_env_memory = w2c_env_memory(w2c_env_instance);
}

const u64 wasm2c_matrix_min_env_memory = 1024;
const u64 wasm2c_matrix_max_env_memory = 65536;
const u8 wasm2c_matrix_is64_env_memory = 0;

void wasm2c_matrix_instantiate(w2c_matrix* instance, struct w2c_env* w2c_env_instance) {
...
void wasm2c_matrix_free(w2c_matrix* instance) {
}
...
void w2c_matrix_performance_test_0(w2c_matrix* instance) {
  ...
  var_L1: 
    ...
    var_L3: 
      ...
      var_l5 = var_i0;
      var_i0 = var_l5;
      var_i1 = w2c_env_rand(instance->w2c_env_instance);
      var_i2 = 100u;
  ...
  var_L5: 
    ...
    var_L7: 
      ...
      var_L9: 
        ...
        var_i2 = instance->w2c_g3;
        var_i3 = var_l2;
        var_i4 = instance->w2c_g0;
        var_i3 *= var_i4;
        var_i4 = var_l1;
        var_i3 += var_i4;
        var_i4 = 4u;
