...
static void w2c_perf__test_f0(w2c_perf__test*);
static u32 w2c_perf__test_calculate_0(w2c_perf__test*, u32);
static void w2c_perf__test_0x5Finitialize_0(w2c_perf__test*);
static void w2c_perf__test_emscripten_stack_init_0(w2c_perf__test*);
static u32 w2c_perf__test_emscripten_stack_get_free_0(w2c_perf__test*);
static u32 w2c_perf__test_emscripten_stack_get_base_0(w2c_perf__test*);
static u32 w2c_perf__test_emscripten_stack_get_end_0(w2c_perf__test*);
static void w2c_perf__test_0x5Femscripten_stack_restore_0(w2c_perf__test*, u32);
static u32 w2c_perf__test_emscripten_stack_get_current_0(w2c_perf__test*);

FUNC_TYPE_T(w2c_perf__test_t0) = "\x72\xab\x00\xdf\x20\x3d\xce\xa1\xf2\x29\xc7\x9d\x13\x40\x7e\x98\xac\x7d\x41\x4a\x53\x2e\x42\x42\x61\x55\x2e\xaa\xeb\xbe\xc6\x35";
FUNC_TYPE_T(w2c_perf__test_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";
FUNC_TYPE_T(w2c_perf__test_t2) = "\x07\x80\x96\x7a\x42\xf7\x3e\xe6\x70\x5c\x2f\xac\x83\xf5\x67\xd2\xa2\xa0\x69\x41\x5f\xf8\xe7\x96\x7f\x23\xab\x00\x03\x5f\x4a\x3c";
FUNC_TYPE_T(w2c_perf__test_t3) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";

static void init_globals(w2c_perf__test* instance) {
  instance->w2c_g0 = 65536u;
  instance->w2c_g1 = 0u;
  instance->w2c_g2 = 0u;
  instance->w2c_mat_a = 65536u;
}

static void init_memories(w2c_perf__test* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 1025, 1025, 0);
}

static const wasm_elem_segment_expr_t elem_segment_exprs_w2c_perf__test_e0[] = {
  {RefFunc, w2c_perf__test_t1, (wasm_rt_function_ptr_t)w2c_perf__test_f0, {NULL}, 0},
};

static void init_tables(w2c_perf__test* instance) {
  wasm_rt_allocate_funcref_table(&instance->w2c_0x5F_indirect_function_table, 2, 2);
  funcref_table_init(&instance->w2c_0x5F_indirect_function_table, elem_segment_exprs_w2c_perf__test_e0, 1, 1u, 0, 1, instance);
}

static void init_elem_instances(w2c_perf__test *instance) {
}
...
/* export: 'calculate' */
u32 w2c_perf__test_calculate(w2c_perf__test* instance, u32 var_p0) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_perf__test_calculate_0(instance, var_p0);
#if WASM_RT_USE_SEGUE
...
u32* w2c_perf__test_mat_a(w2c_perf__test* instance) {
  return &instance->w2c_mat_a;
}

/* export: '_initialize' */
void w2c_perf__test_0x5Finitialize(w2c_perf__test* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  w2c_perf__test_0x5Finitialize_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}
...
void w2c_perf__test_emscripten_stack_init(w2c_perf__test* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  w2c_perf__test_emscripten_stack_init_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}
...
u32 w2c_perf__test_emscripten_stack_get_free(w2c_perf__test* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_perf__test_emscripten_stack_get_free_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
u32 w2c_perf__test_emscripten_stack_get_base(w2c_perf__test* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_perf__test_emscripten_stack_get_base_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
u32 w2c_perf__test_emscripten_stack_get_end(w2c_perf__test* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_perf__test_emscripten_stack_get_end_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
void w2c_perf__test_0x5Femscripten_stack_restore(w2c_perf__test* instance, u32 var_p0) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  w2c_perf__test_0x5Femscripten_stack_restore_0(instance, var_p0);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}
...
u32 w2c_perf__test_emscripten_stack_get_current(w2c_perf__test* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  u32 ret = w2c_perf__test_emscripten_stack_get_current_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
  return ret;
...
void wasm2c_perf__test_instantiate(w2c_perf__test* instance) {
...
void wasm2c_perf__test_free(w2c_perf__test* instance) {
...
void w2c_perf__test_f0(w2c_perf__test* instance) {
  FUNC_PROLOGUE;
  w2c_perf__test_emscripten_stack_init_0(instance);
  FUNC_EPILOGUE;
}

u32 w2c_perf__test_calculate_0(w2c_perf__test* instance, u32 var_p0) {
  ...
  var_l63 = var_i0;
  var_i0 = var_l63;
  var_i0 = i32_load(&instance->w2c_memory, (u64)(var_i0) + 33619968u);
  var_l64 = var_i0;
  var_i0 = var_l64;
  goto var_Bfunc;
  var_Bfunc:;
...
void w2c_perf__test_0x5Finitialize_0(w2c_perf__test* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = 1u;
  var_i0 = !(var_i0);
  if (var_i0) {goto var_B0;}
  w2c_perf__test_f0(instance);
  var_B0:;
  FUNC_EPILOGUE;
}

void w2c_perf__test_emscripten_stack_init_0(w2c_perf__test* instance) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = 65536u;
...
u32 w2c_perf__test_emscripten_stack_get_free_0(w2c_perf__test* instance) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = instance->w2c_g0;
...
u32 w2c_perf__test_emscripten_stack_get_base_0(w2c_perf__test* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
...
u32 w2c_perf__test_emscripten_stack_get_end_0(w2c_perf__test* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
...
void w2c_perf__test_0x5Femscripten_stack_restore_0(w2c_perf__test* instance, u32 var_p0) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = var_p0;
...
u32 w2c_perf__test_emscripten_stack_get_current_0(w2c_perf__test* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = instance->w2c_g0;
  FUNC_EPILOGUE;
