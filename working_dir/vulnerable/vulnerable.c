...
static void w2c_vulnerable_f4(w2c_vulnerable*);
static void w2c_vulnerable_f5(w2c_vulnerable*);
static void w2c_vulnerable_0x5Fstart_0(w2c_vulnerable*);

FUNC_TYPE_T(w2c_vulnerable_t0) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";
FUNC_TYPE_T(w2c_vulnerable_t1) = "\xf6\x98\x1b\xc6\x10\xda\xb7\xb2\x63\x37\xcd\xdc\x72\xca\xe9\x50\x00\x13\xba\x10\x6c\xde\x87\x27\x10\xf8\x86\x2f\xe3\xdb\x94\xe4";
FUNC_TYPE_T(w2c_vulnerable_t2) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_vulnerable_t3) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static void init_globals(w2c_vulnerable* instance) {
  instance->w2c_g0 = 0u;
  instance->w2c_g1 = 16u;
  instance->w2c_g2 = 8u;
  instance->w2c_g3 = 2048u;
}

static void init_memories(w2c_vulnerable* instance) {
...
/* export: '_start' */
void w2c_vulnerable_0x5Fstart(w2c_vulnerable* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  w2c_vulnerable_0x5Fstart_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_vulnerable* instance, struct w2c_wasi__unstable* w2c_wasi__unstable_instance) {
  instance->w2c_wasi__unstable_instance = w2c_wasi__unstable_instance;
}

void wasm2c_vulnerable_instantiate(w2c_vulnerable* instance, struct w2c_wasi__unstable* w2c_wasi__unstable_instance) {
...
void wasm2c_vulnerable_free(w2c_vulnerable* instance) {
...
void w2c_vulnerable_f4(w2c_vulnerable* instance) {
  u32 var_l0 = 0;
  FUNC_PROLOGUE;
...
void w2c_vulnerable_f5(w2c_vulnerable* instance) {
  u32 var_l0 = 0;
  FUNC_PROLOGUE;
...
void w2c_vulnerable_0x5Fstart_0(w2c_vulnerable* instance) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1, var_i2;
  var_i0 = 3100u;
  var_i1 = 3104u;
