...
static void w2c_trap_f1(w2c_trap*, u32);
static void w2c_trap_0x5Fstart_0(w2c_trap*);

FUNC_TYPE_T(w2c_trap_t0) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_trap_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static void init_memories(w2c_trap* instance) {
...
/* export: '_start' */
void w2c_trap_0x5Fstart(w2c_trap* instance) {
#if WASM_RT_USE_SEGUE
  void* segue_saved_base = wasm_rt_segue_read_base();
  wasm_rt_segue_write_base(instance->w2c_memory.data);
#endif
  w2c_trap_0x5Fstart_0(instance);
#if WASM_RT_USE_SEGUE
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_trap* instance, struct w2c_wasi__unstable* w2c_wasi__unstable_instance) {
  instance->w2c_wasi__unstable_instance = w2c_wasi__unstable_instance;
}

void wasm2c_trap_instantiate(w2c_trap* instance, struct w2c_wasi__unstable* w2c_wasi__unstable_instance) {
...
void wasm2c_trap_free(w2c_trap* instance) {
...
void w2c_trap_f1(w2c_trap* instance, u32 var_p0) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1;
  var_i0 = 65536u;
  var_i1 = var_p0;
...
void w2c_trap_0x5Fstart_0(w2c_trap* instance) {
  FUNC_PROLOGUE;
  u32 var_i0;
  var_i0 = 0u;
  w2c_trap_f1(instance, var_i0);
  var_i0 = 0u;
